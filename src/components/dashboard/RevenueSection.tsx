...
const RevenueSection: React.FC = () => {
    return (
        <div className="bg-white rounded-lg p-3 sm:p-4 md:p-6 shadow-sm">
            ...
            <div className='grid grid-cols-1 sm:grid-cols-12 gap-2 sm:grid-items-center'>
                {/* Revenue Amount with Badge */}
                <div className="col-span-1 sm:col-span-4 flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-3 mb-3 sm:mb-1">
                    <div className="flex items-baseline">
                        <span className="text-2xl sm:text-3xl md:text-4xl font-semibold text-gray-900">$528,976</span>
                        <span className="text-2xl sm:text-3xl md:text-4xl font-light text-gray-300">.82</span>
                    </div>
                ...
                {/* Stats Cards Row */}
                <div className="col-span-1 sm:col-span-8 grid grid-cols-2 sm:grid-cols-4 gap-2 sm:gap-3 mb-4 sm:mb-6">
                    {/* Top Sales Card */}
                    <div className="bg-gray-50 rounded-lg p-3 col-span-1">
                        <div className="text-xs text-gray-500 mb-1">Top sales</div>
                        <div className="font-semibold text-lg sm:text-xl text-gray-900 mb-1">72</div>
                    ...
                    <div className="bg-gray-900 rounded-lg p-3 col-span-1 text-white relative">
                        ...
                        <div className="font-semibold text-lg sm:text-xl mb-1">$42,300</div>
                        <div className="flex items-center text-xs">
                    ...
                    <div className="border border-gray-100 rounded-lg p-3 col-span-1">
                        ...
                        <div className="font-semibold text-lg sm:text-xl text-gray-900 mb-1">5</div>
                        <div className="flex items-center">
                    ...
                    <div className="grid xl:grid-cols-2 grid-cols-1 gap-2 sm:gap-3 col-span-1">
                        {/* Value Card */}
                        <div className="border border-gray-100 rounded-lg p-2 sm:p-3">
                            <div className="text-xs text-gray-500 mb-1">Value</div>
                            <div className="font-semibold text-base sm:text-lg text-gray-900 mb-1">88%</div>
                        </div>

                        {/* Win Rate Card */}
                        <div className="border border-gray-100 rounded-lg p-2 sm:p-3">
                            <div className="text-xs text-gray-500 mb-1">Win rate</div>
                            <div className="font-semibold text-base sm:text-lg text-gray-900 mb-1">12%</div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            {/* Date Range */}
            <div className="text-xs text-gray-500 mb-4 sm:mb-6 flex flex-wrap items-center gap-2 sm:gap-0">
                <span>vs prev. $501,640.73</span>
                <span className="mx-0 sm:mx-2">Jun 1 - Aug 31, 2023</span>
                <FiChevronDown size={12} className="text-gray-400" />
            </div>

            {/* User Stats Row */}
            <div className="flex flex-wrap items-center border-t border-gray-100 pt-3 gap-3 sm:gap-8">
                ...
                <button className="ml-auto mt-2 sm:mt-0 bg-gray-900 text-white rounded-full px-4 py-1.5 text-xs font-medium">
                    Details
                </button>
            </div>
        </div>
...
const UserStat: React.FC<UserStatProps> = ({ avatar, bgColor, amount, percent }) => {
    return (
        <div className="flex items-center gap-2">
            <div className={`w-6 h-6 sm:w-7 sm:h-7 rounded-full ${bgColor} flex items-center justify-center text-xs text-white font-medium`}>
                {avatar}
            </div>
            <div>
                <div className="text-xs sm:text-sm font-medium text-gray-900">{amount}</div>
